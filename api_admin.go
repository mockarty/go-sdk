...
func (a *AdminAPI) ListBackupConfigs(ctx context.Context) ([]BackupConfig, error) {
	...
	if err := a.client.do(ctx, "GET", "/api/admin/backups/configs", nil, &configs); err != nil {
		return nil, err
	}
	return configs, nil
}
...
func (a *AdminAPI) GetBackupConfig(ctx context.Context, id string) (*BackupConfig, error) {
	...
	if err := a.client.do(ctx, "GET", "/api/admin/backups/configs/"+url.PathEscape(id), nil, &config); err != nil {
		return nil, err
	}
	return &config, nil
}
...
func (a *AdminAPI) CreateBackupConfig(ctx context.Context, config *BackupConfig) (*BackupConfig, error) {
	...
	if err := a.client.do(ctx, "POST", "/api/admin/backups/configs", config, &result); err != nil {
		return nil, err
	}
	return &result, nil
}
...
func (a *AdminAPI) CreateBackup(ctx context.Context, configID string) (*Backup, error) {
	...
	var result Backup
	if err := a.client.do(ctx, "POST", "/api/admin/backups/create", body, &result); err != nil {
		return nil, err
	}
	return &result, nil
}
...
func (a *AdminAPI) ListBackups(ctx context.Context, configID string) ([]Backup, error) {
	var backups []Backup
	if err := a.client.do(ctx, "GET", "/api/admin/backups/configs/"+url.PathEscape(configID)+"/backups", nil, &backups); err != nil {
		return nil, err
	}
	return backups, nil
}
...
func (a *AdminAPI) DownloadBackup(ctx context.Context, backupID string) ([]byte, error) {
	...
	data, err := a.client.doJSON(ctx, "GET", "/api/admin/backups/download?"+params.Encode(), nil)
	if err != nil {
		return nil, err
	}
	return data, nil
...
func (a *AdminAPI) RestoreBackup(ctx context.Context, backupID string) error {
	...
	return a.client.do(ctx, "POST", "/api/admin/backups/restore", body, nil)
}

// DeleteBackup deletes a backup by ID.
func (a *AdminAPI) DeleteBackup(ctx context.Context, backupID string) error {
	return a.client.do(ctx, "POST", "/api/admin/backups/"+url.PathEscape(backupID)+"/delete", nil, nil)
}
...
func (a *AdminAPI) GetLicenseStatus(ctx context.Context) (*LicenseStatus, error) {
	...
	if err := a.client.do(ctx, "GET", "/api/admin/licenses/status", nil, &status); err != nil {
		return nil, err
	}
	return &status, nil
}
...
func (a *AdminAPI) ListLicenses(ctx context.Context) ([]License, error) {
	...
	if err := a.client.do(ctx, "GET", "/api/admin/licenses", nil, &licenses); err != nil {
		return nil, err
	}
	return licenses, nil
}
...
func (a *AdminAPI) ActivateLicense(ctx context.Context, key string) error {
	...
	return a.client.do(ctx, "POST", "/api/admin/licenses/activate", body, nil)
}
...
func (a *AdminAPI) GetLicenseUsage(ctx context.Context) (*LicenseUsage, error) {
	...
	if err := a.client.do(ctx, "GET", "/api/admin/licenses/usage", nil, &usage); err != nil {
		return nil, err
	}
	return &usage, nil
}
...
func (a *AdminAPI) GetCombinedLimits(ctx context.Context) (*LicenseLimits, error) {
	...
	if err := a.client.do(ctx, "GET", "/api/admin/licenses/combined-limits", nil, &limits); err != nil {
		return nil, err
	}
	return &limits, nil
}
