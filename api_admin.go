...
func (a *AdminAPI) ListUsers(ctx context.Context) ([]User, error) {
	var users []User
	if err := a.client.do(ctx, "GET", "/ui/api/admin/users", nil, &users); err != nil {
		return nil, err
	}
	return users, nil
}
...
func (a *AdminAPI) CreateUser(ctx context.Context, user *CreateUserRequest) (*User, error) {
	var result User
	if err := a.client.do(ctx, "POST", "/ui/api/admin/users", user, &result); err != nil {
		return nil, err
	}
	return &result, nil
}
...
func (a *AdminAPI) UpdateUser(ctx context.Context, id string, user *UpdateUserRequest) (*User, error) {
	var result User
	if err := a.client.do(ctx, "PUT", "/ui/api/admin/users/"+url.PathEscape(id), user, &result); err != nil {
		return nil, err
	}
	return &result, nil
}
...
func (a *AdminAPI) DeleteUser(ctx context.Context, id string) error {
	return a.client.do(ctx, "DELETE", "/ui/api/admin/users/"+url.PathEscape(id), nil, nil)
}
...
func (a *AdminAPI) SetUserPassword(ctx context.Context, id string, password string) error {
	...
	return a.client.do(ctx, "POST", "/ui/api/admin/users/"+url.PathEscape(id)+"/password", body, nil)
}

// DisableUser disables a user account.
func (a *AdminAPI) DisableUser(ctx context.Context, id string) error {
	return a.client.do(ctx, "POST", "/ui/api/admin/users/"+url.PathEscape(id)+"/disable", nil, nil)
}

// EnableUser enables a previously disabled user account.
func (a *AdminAPI) EnableUser(ctx context.Context, id string) error {
	return a.client.do(ctx, "POST", "/ui/api/admin/users/"+url.PathEscape(id)+"/enable", nil, nil)
}
...
func (a *AdminAPI) ListNamespaces(ctx context.Context) ([]AdminNamespace, error) {
	...
	if err := a.client.do(ctx, "GET", "/ui/api/admin/namespaces", nil, &namespaces); err != nil {
		return nil, err
	}
...
func (a *AdminAPI) DeleteNamespace(ctx context.Context, namespace string) error {
	return a.client.do(ctx, "DELETE", "/ui/api/admin/namespaces/"+url.PathEscape(namespace), nil, nil)
}
...
func (a *AdminAPI) RestoreNamespace(ctx context.Context, namespace string) error {
	return a.client.do(ctx, "PUT", "/ui/api/admin/namespaces/"+url.PathEscape(namespace)+"/restore", nil, nil)
}
...
func (a *AdminAPI) ListNamespaceUsers(ctx context.Context, namespace string) ([]NamespaceUser, error) {
	...
	if err := a.client.do(ctx, "GET", "/ui/api/admin/namespaces/"+url.PathEscape(namespace)+"/users", nil, &users); err != nil {
		return nil, err
	}
	return users, nil
}
...
func (a *AdminAPI) AddNamespaceUser(ctx context.Context, namespace string, req *AddNamespaceUserRequest) error {
	return a.client.do(ctx, "POST", "/ui/api/admin/namespaces/"+url.PathEscape(namespace)+"/users", req, nil)
}
...
func (a *AdminAPI) RemoveNamespaceUser(ctx context.Context, namespace string, userID string) error {
	return a.client.do(ctx, "DELETE", "/ui/api/admin/namespaces/"+url.PathEscape(namespace)+"/users/"+url.PathEscape(userID), nil, nil)
}
...
func (a *AdminAPI) UpdateNamespaceUserRole(ctx context.Context, namespace string, userID string, role string) error {
	...
	return a.client.do(ctx, "PUT", "/ui/api/admin/namespaces/"+url.PathEscape(namespace)+"/users/"+url.PathEscape(userID)+"/role", body, nil)
}
...
func (a *AdminAPI) ListBackupConfigs(ctx context.Context) ([]BackupConfig, error) {
	...
	if err := a.client.do(ctx, "GET", "/ui/api/admin/backups/configs", nil, &configs); err != nil {
		return nil, err
	}
	return configs, nil
}
...
func (a *AdminAPI) GetBackupConfig(ctx context.Context, id string) (*BackupConfig, error) {
	...
	if err := a.client.do(ctx, "GET", "/ui/api/admin/backups/configs/"+url.PathEscape(id), nil, &config); err != nil {
		return nil, err
	}
	return &config, nil
}
...
func (a *AdminAPI) CreateBackupConfig(ctx context.Context, config *BackupConfig) (*BackupConfig, error) {
	...
	if err := a.client.do(ctx, "POST", "/ui/api/admin/backups/configs", config, &result); err != nil {
		return nil, err
	}
	return &result, nil
}
...
func (a *AdminAPI) CreateBackup(ctx context.Context, configID string) (*Backup, error) {
	...
	var result Backup
	if err := a.client.do(ctx, "POST", "/ui/api/admin/backups/create", body, &result); err != nil {
		return nil, err
	}
	return &result, nil
}
...
func (a *AdminAPI) ListBackups(ctx context.Context, configID string) ([]Backup, error) {
	var backups []Backup
	if err := a.client.do(ctx, "GET", "/ui/api/admin/backups/configs/"+url.PathEscape(configID)+"/backups", nil, &backups); err != nil {
		return nil, err
	}
	return backups, nil
}
...
func (a *AdminAPI) DownloadBackup(ctx context.Context, backupID string) ([]byte, error) {
	...
	data, err := a.client.doJSON(ctx, "GET", "/ui/api/admin/backups/download?"+params.Encode(), nil)
	if err != nil {
		return nil, err
	}
	return data, nil
...
func (a *AdminAPI) RestoreBackup(ctx context.Context, backupID string) error {
	...
	return a.client.do(ctx, "POST", "/ui/api/admin/backups/restore", body, nil)
}

// DeleteBackup deletes a backup by ID.
func (a *AdminAPI) DeleteBackup(ctx context.Context, backupID string) error {
	return a.client.do(ctx, "POST", "/ui/api/admin/backups/"+url.PathEscape(backupID)+"/delete", nil, nil)
}
...
func (a *AdminAPI) GetLicenseStatus(ctx context.Context) (*LicenseStatus, error) {
	...
	if err := a.client.do(ctx, "GET", "/ui/api/admin/licenses/status", nil, &status); err != nil {
		return nil, err
	}
	return &status, nil
}
...
func (a *AdminAPI) ListLicenses(ctx context.Context) ([]License, error) {
	...
	if err := a.client.do(ctx, "GET", "/ui/api/admin/licenses", nil, &licenses); err != nil {
		return nil, err
	}
	return licenses, nil
}
...
func (a *AdminAPI) ActivateLicense(ctx context.Context, key string) error {
	...
	return a.client.do(ctx, "POST", "/ui/api/admin/licenses/activate", body, nil)
}
...
func (a *AdminAPI) GetLicenseUsage(ctx context.Context) (*LicenseUsage, error) {
	...
	if err := a.client.do(ctx, "GET", "/ui/api/admin/licenses/usage", nil, &usage); err != nil {
		return nil, err
	}
	return &usage, nil
}
...
func (a *AdminAPI) GetCombinedLimits(ctx context.Context) (*LicenseLimits, error) {
	...
	if err := a.client.do(ctx, "GET", "/ui/api/admin/licenses/combined-limits", nil, &limits); err != nil {
		return nil, err
	}
	return &limits, nil
}
...
func (a *AdminAPI) ListWebhooks(ctx context.Context) ([]AdminWebhook, error) {
	...
	if err := a.client.do(ctx, "GET", "/ui/api/admin/webhooks", nil, &webhooks); err != nil {
		return nil, err
	}
	return webhooks, nil
}
...
func (a *AdminAPI) CreateWebhook(ctx context.Context, webhook *AdminWebhook) (*AdminWebhook, error) {
	...
	if err := a.client.do(ctx, "POST", "/ui/api/admin/webhooks", webhook, &result); err != nil {
		return nil, err
	}
	return &result, nil
}
...
func (a *AdminAPI) DeleteWebhook(ctx context.Context, id string) error {
	return a.client.do(ctx, "DELETE", "/ui/api/admin/webhooks/"+url.PathEscape(id), nil, nil)
}
...
func (a *AdminAPI) ExportAuditLogs(ctx context.Context) ([]byte, error) {
	data, err := a.client.doJSON(ctx, "GET", "/ui/api/admin/audit/export", nil)
	if err != nil {
		return nil, err
	}
	return data, nil
...
func (a *AdminAPI) GetCleanupPolicy(ctx context.Context, namespace string) (*CleanupPolicy, error) {
	...
	if err := a.client.do(ctx, "GET", "/ui/api/admin/namespaces/"+url.PathEscape(namespace)+"/cleanup-policy", nil, &policy); err != nil {
		return nil, err
	}
	return &policy, nil
}
...
func (a *AdminAPI) UpdateCleanupPolicy(ctx context.Context, namespace string, policy *CleanupPolicy) error {
	return a.client.do(ctx, "PUT", "/ui/api/admin/namespaces/"+url.PathEscape(namespace)+"/cleanup-policy", policy, nil)
}
...
func (a *AdminAPI) GetDatabaseHealth(ctx context.Context) (*DatabaseHealth, error) {
	...
	if err := a.client.do(ctx, "GET", "/ui/api/admin/database/health", nil, &health); err != nil {
		return nil, err
	}
	return &health, nil
}
