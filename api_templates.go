...
func (a *TemplateAPI) List(ctx context.Context) ([]TemplateFile, error) {
	...
	if err := a.client.do(ctx, "GET", "/api/v1/templates", nil, &files); err != nil {
		return nil, err
	}
	return files, nil
}
...
func (a *TemplateAPI) Get(ctx context.Context, fileName string) ([]byte, error) {
	data, err := a.client.doJSON(ctx, "GET", "/api/v1/templates/"+url.PathEscape(fileName), nil)
	if err != nil {
		return nil, err
	}
	return data, nil
...
func (a *TemplateAPI) Upload(ctx context.Context, fileName string, content []byte) error {
	...
	return a.client.do(ctx, "POST", "/api/v1/templates/"+url.PathEscape(fileName), body, nil)
}

// Delete deletes a template file by name.
func (a *TemplateAPI) Delete(ctx context.Context, fileName string) error {
	return a.client.do(ctx, "DELETE", "/api/v1/templates/"+url.PathEscape(fileName), nil, nil)
}
