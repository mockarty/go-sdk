...
func (a *GeneratorAPI) FromOpenAPI(ctx context.Context, spec *GeneratorRequest) (*GeneratorResponse, error) {
	...
	if err := a.client.do(ctx, "POST", "/ui/api/generator/openapi/generate", spec, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
...
func (a *GeneratorAPI) FromWSDL(ctx context.Context, spec *GeneratorRequest) (*GeneratorResponse, error) {
	...
	var resp GeneratorResponse
	if err := a.client.do(ctx, "POST", "/ui/api/generator/soap/generate", spec, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
...
func (a *GeneratorAPI) FromProto(ctx context.Context, spec *GeneratorRequest) (*GeneratorResponse, error) {
	...
	var resp GeneratorResponse
	if err := a.client.do(ctx, "POST", "/ui/api/generator/grpc/generate", spec, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
...
func (a *GeneratorAPI) FromGraphQL(ctx context.Context, spec *GeneratorRequest) (*GeneratorResponse, error) {
	...
	var resp GeneratorResponse
	if err := a.client.do(ctx, "POST", "/ui/api/generator/graphql/generate", spec, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
...
func (a *GeneratorAPI) FromHAR(ctx context.Context, spec *GeneratorRequest) (*GeneratorResponse, error) {
	...
	var resp GeneratorResponse
	if err := a.client.do(ctx, "POST", "/ui/api/generator/har/generate", spec, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
...
func (a *GeneratorAPI) FromSocket(ctx context.Context, spec *GeneratorRequest) (*GeneratorResponse, error) {
	...
	var resp GeneratorResponse
	if err := a.client.do(ctx, "POST", "/ui/api/generator/socket/generate", spec, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
...
func (a *GeneratorAPI) PreviewOpenAPI(ctx context.Context, spec *GeneratorRequest) (*GeneratorPreview, error) {
	...
	if err := a.client.do(ctx, "POST", "/ui/api/generator/openapi/preview", spec, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
...
func (a *GeneratorAPI) PreviewWSDL(ctx context.Context, spec *GeneratorRequest) (*GeneratorPreview, error) {
	...
	var resp GeneratorPreview
	if err := a.client.do(ctx, "POST", "/ui/api/generator/soap/preview", spec, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
...
func (a *GeneratorAPI) PreviewProto(ctx context.Context, spec *GeneratorRequest) (*GeneratorPreview, error) {
	...
	var resp GeneratorPreview
	if err := a.client.do(ctx, "POST", "/ui/api/generator/grpc/preview", spec, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
...
func (a *GeneratorAPI) PreviewGraphQL(ctx context.Context, spec *GeneratorRequest) (*GeneratorPreview, error) {
	...
	var resp GeneratorPreview
	if err := a.client.do(ctx, "POST", "/ui/api/generator/graphql/preview", spec, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
...
func (a *GeneratorAPI) PreviewHAR(ctx context.Context, spec *GeneratorRequest) (*GeneratorPreview, error) {
	...
	var resp GeneratorPreview
	if err := a.client.do(ctx, "POST", "/ui/api/generator/har/preview", spec, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
